    ...
    methods: {
        ...
        searchForm() {
            $(`input[type=text], input[type=password]`).on("blur", function () {
                ...
                if (cv === "") {
                    // 경고메시지 나타남
                    $(this).siblings(".msg").text("필수 정보입니다.").removeClass("on") &&
                        $(this).parent().siblings(".msg").text("필수 정보입니다.").removeClass("on");
                ...
                // 아이디 유효성 검사
                    ...
                    if (!vReg(cv, cid)) {
                        // 불통과일때 메시지
                        $(this).siblings(".msg").text("영문자로 시작하는 6~20글자 영문자/숫자만 가능합니다.").removeClass("on") &&
                            $(this).parent().siblings(".msg").text("영문자로 시작하는 6~20글자 영문자/숫자만 가능합니다.").removeClass("on");
                        ...
                        $(this).siblings(".msg").text("멋진 아이디네요!").addClass("on") &&
                            $(this).parent().siblings(".msg").text("멋진 아이디네요!").addClass("on");
                    } /// else ////
                } ///////////// else if : 아이디 검사시 ///////////
